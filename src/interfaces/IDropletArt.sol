...
interface IDropletArt {
    ...
    struct Trait {
        DropletArtStoragePage[] storagePages;
    ...
    function background(uint256 index) external view returns (string memory);

    function color(uint256 index) external view returns (bytes memory);

    function noggles(uint256 index) external view returns (bytes memory);

    function number(uint256 index) external view returns (bytes memory);

    function mood(uint256 index) external view returns (bytes memory);

    function getBackgroundTrait() external view returns (Trait memory);

    function getColorTrait() external view returns (Trait memory);

    function getNumberTrait() external view returns (Trait memory);

    function getMoodTrait() external view returns (Trait memory);
}